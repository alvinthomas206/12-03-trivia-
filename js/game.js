    ...
    play() {
      ...
      textSize(32);
         ...
         index = index + 1;
          ...
          players[index - 1].playerGameState = 1;
          players[index - 1].playerGameState = 1;
      ...
      if (player1.playerGameState===1 && player2.playerGameState===1 ){
  ...
  birdsGroup.destroyEach();
    ...
    if (missileGroup.isTouching(bulletGroup)){
     ...
     console.log("player"+player.name)
      ...
      if(player1.collide(invisibleGround)||player2.collide(invisibleGround2)||player1.collide(invisibleGround)||player2.collide(invisibleGround2)){
       }
       else{
        player.distance1 += 20
...
//code for creating bullet from aliens
     ...
     console.log(player1.playerGameState)
     console.log(player2.playerGameState)
...
//player2 win
    if(player2.playerGameState===3){
      ...
      var p = createElement("h1",player.name + " is " );
    ...
    win(){
      ...
      var p = createElement("h1",player.name + " is " + "win");
      p.position(displayWidth/2,150);
      var x = createElement("IMG");
      x.src = ""
    }
